var FormValidation = function () {
						...
						success:function(result) {
							if(result.status=="SUCCESS"){
								showSucessMsg("Record generated successfully", "Generating Record");
									...
									window.location.href = "/admin/room/availability?id="+result.id+"&type=availability&rmstatus="+result.rmstatus;
									return;
    ...
    var CalendarValidation1 = function() {
            var form2 = $('#availability_calendar');
