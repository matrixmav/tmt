var FormValidation = function () {
    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            var form1 = $('#form_sample_3_customer');
					...
					$.ajax({
						...
						success:function(result) {
							if(result.status=="SUCCESS"){
								showSucessMsg("Record saved successfully", "Save Customer");
								...
								if(currentUrl.indexOf("create") > -1 || currentUrl.indexOf("update") > -1){
									...
									window.location.href = "/admin/customer/"+type;
									return;
								}
						...
						error:function(status, respone, error) {
							showError("Customer is already registered");
							App.unblockUI();
						}
					});
                }
