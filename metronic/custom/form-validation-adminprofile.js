    ...
    var handleValidation1 = function() {
        // for more info visit the official plugin documentation: 
            ...
            form1.validate({
                ...
                ignore: "",
                rules: {
                    'AdminUser[passwordOrig]': {
                    	required: true,
                    },
                    'AdminUser[password]': {
                    	required: true,
                    },
                    'AdminUser[passwordSecond]': {
                    	required: true,
                        equalTo: "#password",
                    }
                },
					...
					$.ajax({
						...
						success:function(result) {
							if(result.status=="SUCCESS"){
								showSucessMsg("Password changed successfully", "Save Admin Password");
