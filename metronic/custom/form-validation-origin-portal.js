					...
					$.ajax({
						...
						success:function(result) {
							if(result.status=="SUCCESS"){
								showSucessMsg("Record saved successfully", "Save Origin");
								...
								if(currentUrl.indexOf("create") > -1 || currentUrl.indexOf("update") > -1){
									...
									window.location.href = "/admin/origin";
									return;
								}		
							}
                            else if(result.status=="EMPTY"){
                                    showError("You have left any of the portal unchecked");
