...
class UserHasProject extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('user_id, project_id, created_at, updated_at', 'required'),
			array('user_id, project_id', 'numerical', 'integerOnly'=>true),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, user_id, project_id, created_at, updated_at', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
                    'trackRecord' => array(self::BELONGS_TO, 'TrackRecord', 'user_id'),
		);
	}
