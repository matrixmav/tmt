            ...
            <div class="header-inner">
                ...
                <ul class="nav navbar-nav pull-right">
                    ...
                    <li class="dropdown user">
                        <a href="#" class="dropdown-toggle" datapull-right inlineBlock-toggle="dropdown" data-hover="dropdown" data-close-others="true"> <span class="username">
                            <?php 
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                    <a href="/user/logout"> <i class="fa fa-key"></i> Log Out
                                    </a>
                            </li>
                        </ul></li>
                    ...
                    <ul class="page-sidebar-menu" data-auto-scroll="true"
                        ...
                        if ($access != "manager") {
                            ...
                            if ((in_array($hotel_pmenu, $menusections ['psections'])) || (in_array($hotel_pmenu, $menusections ['section_ids']))) {
                                ...
                                if ($curControllerLower == 'user' && $curActionLower == 'BugReport')
                                    $activecls = 'active';
                            ...
                            if ((in_array($hotel_pmenu, $menusections ['psections'])) || (in_array($hotel_pmenu, $menusections ['section_ids']))) {
                                $hotel_subsection = array(
                                    "/BugReport" => "mGlobally",
                                    "/BugReport?pid=5" => "UR Webby",
                                    
                                );
                                $activecls = 'active';
                                if ($curControllerLower == "BugReport" || $curControllerLower == "BugReport") {
                                    $activecls = 'active';
                                } else {
                                    $activecls = '';
                                }
                                if ($curControllerLower == 'BugReport' && $curActionLower == 'BugReport')
                                    $activecls = 'active';
                                if ($curActionLower == 'simplename')
                                    $activecls = '';
                                ?>
                                <li class="<?php echo $activecls; ?>"><a href="javascript:;"> <span
                                            class="leftmenu-hotel"></span> <span class="title">BugReport</span>
                                        <span class="selected"></span> <span
                                            class="arrow <?php echo ($curControllerLower == 'BugReport') ? "open" : ''; ?>">
                                        </span>
                                    </a>
                                    <?php
                                    $menusections ['sections'] = $hotel_subsection;
