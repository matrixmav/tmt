...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'to_time',array('size'=>10,'maxlength'=>10)); ?>
		<?php echo $form->error($model,'to_time'); ?>
	</div>

	<div class="row">
		<?php echo $form->labelEx($model,'from_time'); ?>
		<?php echo $form->textField($model,'from_time',array('size'=>10,'maxlength'=>10)); ?>
